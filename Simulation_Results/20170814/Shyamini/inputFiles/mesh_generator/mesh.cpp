...
int main () {
    ...
    int xnumNodes = (xmax + 0.00000001 - xmin)/xspacing + 1;
    int ynumNodes = (ymax + 0.00000001 - ymin)/yspacing + 1;
    int xnumElem = (xmax + 0.00000001 - xmin) / (xspacing);
    int ynumElem = (ymax + 0.00000001 - ymin) / (yspacing);
